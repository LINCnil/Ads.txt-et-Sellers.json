...
function fillcube(network,data){
    ...
    var mousemove = function(d) {
        Tooltip
        .html("<br><br> <span style='background-color:"+defaultcolor[network]+"'> "+ network+" est présent dans "+defaultStat[network]+"% des 400 sites les plus populaires ayant un registre Ads.txt")
    }
