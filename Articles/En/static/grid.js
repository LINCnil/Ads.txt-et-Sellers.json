...
d3.json("static/data_grid.json", function(data) {
    ...
    var mousemove = function(d) {
        if(d.numsite>1){
            Tooltip
            .html("The website "+d.name+" uses <br><span style='background-color:"+d.colour+"'>" + d.numsite+ " different adsystems</span>")
            .style("left", (d3.event.pageX+20) + "px")
            .style("top", (d3.event.pageY) + "px")
        }else{
            Tooltip
            .html("The website "+d.name+" uses <br><span style='background-color:"+d.colour+"'>" + d.numsite+ " adsystem</span>")
            .style("left", (d3.event.pageX+20) + "px")
            .style("top", (d3.event.pageY) + "px")
        }
    }
